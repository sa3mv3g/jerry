...
#define APPTASK_SYSLOG_TASK_EVENT_ID    (7U)
...
#define APPTASK_SYSLOG_TASK_EVENT_MASK  (1U << APPTASK_SYSLOG_TASK_EVENT_ID)
...
#define APPTASK_ALL_TASK_EVENT_MASK                                        \
    (APPTASK_LOGGING_TASK_EVENT_MASK | APPTASK_MODBUS_TASK_EVENT_MASK |    \
     ...
     APPTASK_MAIN_TASK_EVENT_MASK | APPTASK_SYSLOG_TASK_EVENT_MASK)
