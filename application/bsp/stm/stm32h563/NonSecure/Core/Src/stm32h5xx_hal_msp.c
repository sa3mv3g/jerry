...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = VBUS_SENSE_Pin|GPIO_PIN_6;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOA, VBUS_SENSE_Pin|GPIO_PIN_6);
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  else if(htim_base->Instance==TIM3)
  {
    ...
    __HAL_LINKDMA(htim_base, hdma[TIM_DMA_ID_CC4], handle_GPDMA1_Channel4);
    ...
    __HAL_LINKDMA(htim_base, hdma[TIM_DMA_ID_CC3], handle_GPDMA1_Channel3);
