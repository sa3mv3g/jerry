 ...
 * @brief   wolfSSL configuration for FOTA firmware verification (Secure firmware only).
 *
 * wolfSSL uses this file instead of a CMake config file when WOLFSSL_USER_SETTINGS is defined.
 *
 * Configuration goals:
 ...
 *   Also enable HAL_HASH_MODULE_ENABLED + HAL_PKA_MODULE_ENABLED in stm32h5xx_hal_conf.h.
 */
