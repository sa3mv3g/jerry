 ...
 *
 * @note The coil_values buffer is pre-zeroed before this callback is called.
 */
 ...
 *
 * Called when a Write Multiple Coils request is received. The implementation
 * should set the coils starting at the specified address to the given values.
 *
 * @param[in] start_address Starting coil address (0-based)
 ...
 *
 * Called when a Read Discrete Inputs request is received. The implementation
 * should read the input values starting at the specified address and pack
 * them into the output buffer (LSB first, bit 0 = first input).
 *
 ...
 * @return MODBUS_EXCEPTION_NONE on success, or appropriate exception code
 *
 * @note The input_values buffer is pre-zeroed before this callback is called.
 */
 ...
 *
 * Called when a Read Holding Registers request is received. The implementation
 * should read the register values starting at the specified address.
 *
 ...
 *
 * Called when a Write Single Register request is received. The implementation
 * should set the specified register to the given value.
 *
 ...
 * implementation should set the registers starting at the specified address to
 * the given values.
 *
 * @param[in] start_address   Starting register address (0-based)
 ...
 *
 * Called when a Read Input Registers request is received. The implementation
 * should read the register values starting at the specified address.
 *
 * @param[in]  start_address   Starting register address (0-based)
 * @param[in]  quantity        Number of registers to read (1-125)
 ...
 *
 * These callbacks are optional and provide hooks for monitoring and logging.
