...
#define MODBUS_VERSION_STRING "1.0.0"
     ...
     */
    modbus_error_t modbus_slave_process(modbus_context_t *ctx,
     ...
     * @return MODBUS_OK on success, error code on failure
     */
    modbus_error_t modbus_master_read_holding_registers(
     ...
     * @return MODBUS_OK on success, error code on failure
     */
    modbus_error_t modbus_master_read_input_registers(
        modbus_context_t *ctx, uint8_t slave_addr, uint16_t start_address,
        uint16_t quantity, uint16_t *register_values);
     ...
     * @return MODBUS_OK on success, error code on failure
     */
    modbus_error_t modbus_master_write_multiple_coils(
        modbus_context_t *ctx, uint8_t slave_addr, uint16_t start_address,
