...
typedef int32_t (*lan8742_WriteReg_Func)(uint32_t DevAddr, uint32_t RegAddr, uint32_t RegVal);
typedef int32_t (*lan8742_ReadReg_Func)(uint32_t DevAddr, uint32_t RegAddr, uint32_t *pRegVal);
